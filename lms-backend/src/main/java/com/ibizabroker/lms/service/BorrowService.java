...
public class BorrowService {
    ...
    public String borrowBook(Integer userId, Integer bookId) {
        ...
        List<ReturnStatus> activeStatuses = Arrays.asList(ReturnStatus.NONE, ReturnStatus.PENDING, ReturnStatus.REJECTED);
        ...
        borrow.setReturnRequestStatus(ReturnStatus.PENDING);
    ...
    public List<Borrow> getOverdueBooks() {
        return borrowRepository.findOverdueBooks(ReturnStatus.APPROVED);
    }
    ...
    public long getTotalOverdueBooks() {
        long overdueBooks = borrowRepository.countOverdueBooks(ReturnStatus.APPROVED);
